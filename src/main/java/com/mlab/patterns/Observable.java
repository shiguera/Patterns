 ...
 * {@link com.mlab.roadplayer.acore.CompositeObserver} que son notificados 
 * a través del método <em>notifyObservers()</em>.<br/>
 * Los {@link com.mlab.roadplayer.acore.CompositeObserver} disponen de un método <em>update()</em> que
 * es el utilizado por el <em>CompositeObserver</em> en el método <em>notifyObservers()</em> 
 ...
 * 
 * El {@link com.mlab.roadplayer.acore.CompositeObserver} tiene que utilizar el método 
 ...
 * en el patrón de diseño <em>Model-View-CompositeObserver</em>
 *
